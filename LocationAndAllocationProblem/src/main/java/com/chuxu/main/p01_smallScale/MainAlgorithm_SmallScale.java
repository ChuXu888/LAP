...
import com.chuxu.main.p01_smallScale.part04_upBound.UpBoundAlgorithm;
import com.chuxu.main.p01_smallScale.part06_orderReductionAlgorithm.OrderReductionAlgorithm;
import com.chuxu.main.p01_smallScale.part07_backStrackingAlgorithm.BackTrackingAlgorithm;

import java.util.*;

public class MainAlgorithm_SmallScale {
    ...
    public static void main(String[] args) throws Exception {
        ...
        //3.上界子算法
        UpBoundAlgorithm.upBoundAlgorithm();
        ...
        if (!(F0.isEmpty() && F1.isEmpty())) {
            System.out.println("降阶子算法结束后(F0∪F1)发生变化，重新计算上界：");
            UpBoundAlgorithm.upBoundAlgorithm();
            System.out.println("u = " + u);
            printAll();
        }
