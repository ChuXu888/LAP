package com.chuxu.main.p01_smallScale.part04_upBound;
...
public class UpBoundAlgorithm {
    ...
    public static void upBoundAlgorithm() {
        System.out.println("============================================================================");
        System.out.println("============================================================================");
        ...
        if (!singleCommunityCandidate.isEmpty()) {
            ...
            //打印S看看咯
            MainAlgorithm_SmallScale.S.forEach(System.out::println);
            ...
            F.forEach(System.out::println);
            //将上界子算法中的F拷贝给主函数中的F
            MainAlgorithm_SmallScale.F.clear();
            for (Candidate candidate : F) {
                MainAlgorithm_SmallScale.F.add(candidate.clone());
            }
            System.out.println("反拷贝结束后：");
            MainAlgorithm_SmallScale.F.forEach(System.out::println);
            System.out.println("=================================================");
            System.out.println("经过性质4处理后的F1：");
            F1.forEach(System.out::println);
            //将上界子算法中的F拷贝给主函数中的F1
            MainAlgorithm_SmallScale.F1.clear();
            for (Candidate candidate : F1) {
                MainAlgorithm_SmallScale.F1.add(candidate.clone());
            }
            System.out.println("反拷贝结束后：");
            MainAlgorithm_SmallScale.F1.forEach(System.out::println);
            System.out.println("=================================================");
//            System.out.println("经过性质4处理后的F0：");
//            F0.forEach(System.out::println);
            //将上界子算法中的F拷贝给主函数中的F1
            MainAlgorithm_SmallScale.F0.clear();
            for (Candidate candidate : F0) {
                MainAlgorithm_SmallScale.F0.add(candidate.clone());
            }
//            System.out.println("反拷贝结束后：");
...
//            E.forEach(System.out::println);
            MainAlgorithm_SmallScale.E.clear();
            for (Community community : E) {
                MainAlgorithm_SmallScale.E.add(community.clone());
            }
//            System.out.println("反拷贝结束后：");
...
//            E1.forEach(System.out::println);
            MainAlgorithm_SmallScale.E1.clear();
            for (Community community : E1) {
                MainAlgorithm_SmallScale.E1.add(community.clone());
            }
//            System.out.println("反拷贝结束后：");
            ...
            if (F_up.size() <= K) {
                ...
                for (Map.Entry<Candidate, List<Community>> entry : hashMap.entrySet()) {
                    ...
                    for (Community curCommunity : curCommunities) {
                        int columnIndex = curCommunity.getId() - 1;
                        double curDis = MainAlgorithm_SmallScale.disMatrix[rowIndex][columnIndex];
            ...
            for (Candidate fk : Fup_Minus_F1_Minus_Ftemp) {
                ...
                if (E_temp_fk != null && E_temp_fk.size() != 0) {
                    ...
                    for (Community ei : E_temp_fk) {
                        ...
                        double minDis = MainAlgorithm_SmallScale.disMatrix[rowIndex][columnIndex];
