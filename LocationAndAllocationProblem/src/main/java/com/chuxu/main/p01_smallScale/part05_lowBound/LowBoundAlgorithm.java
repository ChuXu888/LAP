package com.chuxu.main.p01_smallScale.part05_lowBound;
...
import com.chuxu.main.p01_smallScale.MainAlgorithm_SmallScale;
...
import static com.chuxu.main.p01_smallScale.MainAlgorithm_SmallScale.*;

public class LowBoundAlgorithm {
    ...
    public static double lowBoundAlgorithm(List<Candidate> F, List<Candidate> F0, List<Candidate> F1, List<Candidate> FF0, List<Candidate> FF1, List<Community> E, List<Community> E1, List<Community> EE1) {
        System.out.println("============================================================================");
        System.out.println("============================================================================");
        ...
        List<Candidate> deletedCandidates = com.chuxu.main.p01_smallScale.part02_properties.Properties.property07(F, E);
        ...
        if (!com.chuxu.main.p01_smallScale.part02_properties.Properties.property02(F1_Add_FF1_Add_FF5, E)) {
            System.out.println("该情况下无可行解！");
            return b_limit;
        }
        if (!com.chuxu.main.p01_smallScale.part02_properties.Properties.property03(F1_Add_FF1_Add_FF5, E)) {
            System.out.println("该情况下无可行解！");
            return b_limit;
        }
        ...
        LinkedHashMap<Community, Candidate> singleCommunityCandidate = com.chuxu.main.p01_smallScale.part02_properties.Properties.property05(F1_Add_FF1_Add_FF5, E);
        //做非空判断
...
//            System.out.println(serveCouple);
            ...
            Community curCommunity = MainAlgorithm_SmallScale.EE5.get(serveCouple.getCommunityId() - 1).clone();
            Candidate curCandidate = MainAlgorithm_SmallScale.FF5.get(serveCouple.getCandidateId() - 1).clone();
            //计算更新后的容量
