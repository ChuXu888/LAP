...
import com.chuxu.main.part01_preHandledData.*;
import com.chuxu.main.part02_properties.Properties;
import com.chuxu.main.part03_allocationAlgorithm.AllocationAlgorithm;
import com.chuxu.main.part04_upperBoundAlgorithm.UpperBoundAlgorithm;
import com.chuxu.main.part06_orderReductionAlgorithm.OrderReductionAlgorithm;
import com.chuxu.main.part07_backTrackingAlgorithm.BackTrackingAlgorithm;

import java.util.*;

import static com.chuxu.main.part01_preHandledData.PreHandleData_RealExample.capacities;

public class MainAlgorithm {

    public static final double[][] disMatrix = PreHandleData_RealExample.disMatrix;  //居民区和备选点之间的距离矩阵
    public static final int K = PreHandleData_RealExample.K;  //选址数量上限
    ...
    public static int countOfProperty06 = 0;  //二叉树搜索中性质6使用次数
    public static int countOfProperty08 = 0;  //二叉树搜索中性质8使用次数

    public static void main(String[] args) throws Exception {

        //0.数据预处理
        PreHandleData_RealExample.preHandle();
        ...
        if (F1.size() < K) {
            ...
            System.out.println("F0.size() = " + F0.size());
            System.out.println("F5.size() = " + (FF5.size() - F0.size() - F1.size()));
...
//            F0.forEach(System.out::println);
            ...
            System.out.println("二叉树搜索中性质6使用次数 = " + countOfProperty06);
            System.out.println("二叉树搜索中性质8使用次数 = " + countOfProperty08);
            System.out.println("=======================================================");
            System.out.println("u = " + u);
            ...
            System.out.println("=======================================================");
            System.out.println("capacities = " + Arrays.toString(capacities));
            System.out.println("=======================================================");
    ...
    public static void deepCopy() {
        List<Candidate> candidates = PreHandleData_RealExample.candidates;
        List<Community> communities = PreHandleData_RealExample.communities;
