...
public class PreHandleData_n12_1 {
    ...
    public static double[][] disMatrix = {
            {5, 7, 8, INF, INF, INF, INF, INF, INF, INF, INF, INF, INF, INF, INF, INF, INF, INF, INF, INF},
            {3, 9, INF, 6, INF, 7, INF, INF, INF, INF, INF, INF, INF, INF, INF, INF, INF, INF, INF, INF},
            {INF, 4, INF, 5, INF, 8, 7, INF, INF, INF, INF, INF, INF, INF, INF, INF, INF, INF, INF, INF},
            {INF, INF, 10, INF, 6, INF, 3, 5, 8, INF, INF, INF, INF, INF, INF, INF, INF, INF, INF, INF},
            {INF, INF, INF, 10, INF, 7, INF, 5, INF, 2, INF, INF, INF, INF, INF, INF, INF, INF, INF, INF},
            {INF, INF, INF, INF, INF, INF, INF, 8, 9, 7, 6, 4, INF, INF, INF, INF, INF, INF, INF, INF},
            {INF, INF, INF, INF, INF, INF, INF, INF, INF, 8, 7, 9, INF, INF, INF, INF, INF, INF, INF, INF},
            {INF, INF, INF, INF, INF, INF, INF, INF, INF, 6, INF, 3, 5, 9, INF, INF, INF, INF, INF, INF},
            {INF, INF, INF, INF, INF, INF, INF, INF, INF, INF, INF, 7, 4, INF, 2, 6, 8, INF, INF, INF},
            {INF, INF, INF, INF, INF, INF, INF, INF, INF, INF, INF, INF, INF, 5, 4, INF, 7, 6, INF, INF},
            {INF, INF, INF, INF, INF, INF, INF, INF, INF, INF, INF, INF, INF, INF, INF, 9, 4, 5, 7, 6},
            {INF, INF, INF, INF, INF, INF, INF, INF, INF, INF, INF, INF, INF, INF, INF, INF, INF, 7, 8, 9},
    };

    //人口向量
    public static final int[] populationNums = {1000, 1500, 1800, 2000, 1700, 2000, 1200, 800, 700, 1100, 1000, 900, 1700, 2000, 1200, 800, 1000, 1200, 1500, 900};

    //容量向量
    public static final double[] capacities = {2000, 2500, 2000, 2500, 2000, 4000, 2500, 2000, 2500, 2000, 4000, 2500};
