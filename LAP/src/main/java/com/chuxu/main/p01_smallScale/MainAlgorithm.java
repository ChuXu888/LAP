...
public class MainAlgorithm {
    ...
    public static final double[][] disMatrix = PreHandleData_n7_1.disMatrix;  //居民区和备选点之间的距离矩阵
    public static final int K = PreHandleData_n7_1.K;  //选址数量上限
...
//            }
    ...
    public static void deepCopy() {
        List<Candidate> candidates = PreHandleData_n7_1.candidates;
        List<Community> communities = PreHandleData_n7_1.communities;
