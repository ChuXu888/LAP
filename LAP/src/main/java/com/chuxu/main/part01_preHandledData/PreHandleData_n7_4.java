...
public class PreHandleData_n7_4 {
    ...
    public static double[][] disMatrix = {
            {INF, INF, INF, INF, INF, 9.0, 10.0, INF},
            {INF, 10.0, INF, 2.0, 8.0, INF, INF, 9.0},
            {3.0, 7.0, INF, 3.0, 3.0, 5.0, INF, INF},
            {6.0, 4.0, INF, INF, INF, 5.0, 4.0, INF},
            {1.0, INF, INF, 7.0, INF, INF, 9.0, 1.0},
            {INF, 1.0, INF, 9.0, INF, INF, INF, 4.0},
            {4.0, INF, 6.0, INF, INF, INF, INF, 1.0},
    };

    //人口向量
    public static final int[] populationNums = {1065, 1337, 1626, 1232, 1923, 1543, 1676, 1142};

    //容量向量
    public static final double[] capacities = {3142.0, 1848.0, 1552.0, 1943.0, 2335.0, 3121.0, 2280.0};
