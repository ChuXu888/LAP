...
public class PreHandleData_n10_1 {
    ...
    public static double[][] disMatrix = {
            {INF, INF, 9.0, INF, INF, 3.0, INF, 6.0, INF, INF, INF, INF, INF, INF, INF},
            {INF, INF, INF, INF, INF, INF, 10.0, INF, INF, 9.0, INF, INF, INF, INF, INF},
            {INF, INF, INF, INF, INF, INF, INF, INF, 7.0, INF, INF, 7.0, INF, INF, INF},
            {6.0, INF, INF, 10.0, 3.0, INF, INF, INF, INF, 3.0, 3.0, INF, INF, 7.0, INF},
            {INF, INF, INF, INF, 9.0, INF, INF, INF, INF, INF, INF, INF, INF, 0.0, INF},
            {INF, INF, 3.0, INF, INF, INF, INF, INF, 7.0, INF, INF, INF, INF, INF, INF},
            {6.0, INF, INF, INF, INF, INF, INF, INF, INF, INF, INF, 9.0, 10.0, INF, INF},
            {10.0, INF, INF, INF, INF, 9.0, INF, INF, INF, INF, INF, INF, INF, INF, 3.0},
            {INF, INF, INF, INF, INF, INF, INF, INF, INF, INF, INF, INF, INF, 6.0, INF},
            {INF, 7.0, INF, INF, INF, INF, INF, INF, INF, 9.0, 1.0, INF, 7.0, 8.0, INF}
    };

    //人口向量
    public static final int[] populationNums = {1071, 1817, 1750, 1573, 591, 727, 980, 793, 1388, 669, 1303, 1781, 733, 1760, 1600};

    //容量向量
    public static final double[] capacities = {1843.0, 2053.0, 1806.0, 3293.0, 2607.0, 2405.0, 1991.0, 1830.0, 2738.0, 1869.0};
