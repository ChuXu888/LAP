...
public class PreHandleData_n7_5 {
    ...
    public static double[][] disMatrix = {
            {9.0, INF, 9.0, INF, INF, INF, INF, INF},
            {INF, INF, INF, INF, INF, INF, INF, 3.0},
            {INF, INF, 2.0, INF, INF, INF, INF, INF},
            {INF, INF, INF, INF, 9.0, INF, INF, INF},
            {INF, 8.0, INF, 8.0, INF, 2.0, INF, 8.0},
            {3.0, INF, INF, 10.0, INF, INF, INF, INF},
            {INF, INF, INF, 6.0, INF, INF, 1.0, 7.0},
    };

    //人口向量
    public static final int[] populationNums = {1047, 1808, 1806, 1161, 1011, 1600, 1031, 1459};

    //容量向量
    public static final double[] capacities = {3404.0, 2248.0, 3224.0, 2904.0, 2789.0, 3460.0, 3566.0};
